  ...
  <div class="row">
    <div class="col-sm-offset-3 col-sm-6">
      <div class="col-md-12 panel panel-body " style="padding: 25px;padding-top: 10px;">
        ...
        @endif
        {{ Form::open(array('method'=>'put','route'=>array('lostandfound.update',$lostandfound->id),'class' => 'form-horizontal','id'=>'semesterForm')) }}
        <div class="form-group">
          <div class="col-md-12">
            {{ Form::label('identifier','Item Identifier') }}
            {{ Form::text('identifier',$lostandfound->identifier,[
              'required',
              'class'=>'form-control',
        ...
        <div class="form-group">
          <div class="col-md-12">
            ...
            {{ Form::textarea('description',$lostandfound->description,[
              'required',
              'class'=>'form-control',
        ...
        <div class="form-group">
          <div class="col-md-12">
            ...
            {{ Form::text('datefound',$lostandfound->datefound,[
              'data-language'=>"en",
              'id' => 'datefound',
              'class'=>'form-control',
              'readonly',
...
<script>
  $(document).ready(function(){
    ...
    $("#datefound").val(moment('{{ Carbon\Carbon::parse($lostandfound->datefound) }}').format('MMMM DD, YYYY'));
