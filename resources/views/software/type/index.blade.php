...
<div class="container-fluid" id="page-body">
	<div class="col-sm-offset-2 col-sm-8" id="software-info">
		<div class="panel panel-body table-responsive">
	        ...
	        @endif
			<table class="table table-hover table-condensed table-bordered table-striped" id="softwareTable">
				<thead>
					<th>Types</th>
		...
		var table = $('#softwareTable').DataTable( {
	        ...
	        columns: [
	            ...
	            { data: function(callback){
	            	return `
	            		<button type="button" data-type="`+callback.type+`" class="btn btn-sm btn-info edit">Edit</button>
